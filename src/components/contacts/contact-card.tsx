...
const ContactCard = () => {
  return (
    <div className="w-[700px] bg-[#44475a] flex items-center rounded p-3 mx-auto mt-6">
      ...
      <div className="w-[260px] h-[150px] flex justify-center items-center mr-2 p-1 bg-[#f8f8f2] rounded">
        <div className="text-md ">
          <div className="py-2">
            نام و نام خانوادگی: <span>علی قدوسی</span>
          </div>
          <div className="border-solid border-t-2 border-[#6272a4] py-2">
      ...
      <div className="mr-6 grid gap-y-4">
